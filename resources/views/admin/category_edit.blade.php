...
{{--                                <option value="{{$data->parent_id}}" ></option>--}}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" value="{{$data->description}}" aria-label="Username">
                        </div>
                        <div class="form-group">
                            <label>Keyword</label>
                            <input type="text" class="form-control form-control-sm" value="{{$data->keyword}}" aria-label="Username">
                        </div>
                        <div class="form-group">
                            <label>Slug</label>
                            <input type="text" name="slug" class="form-control form-control-sm" value="{{$data->slug}}" aria-label="Username">
                        </div>
                        <div class="form-group">
                            <label>Status</label>
                            <div class="form-group">
